...
Funcionalidade: Cadastrar um novo produto
    ...
    Esquema do Cenário: Validar o cadastro de um novo produto
        ...
        |Teclado Redragon         |          |Melhor Teclado para o seu gameplay   |1000        |Preco é obrigatório                 |
        |Teclado Redragon         |300       |                                     |1000        |Descricao não pode ficar em branco  |
        |Teclado Redragon         |300       |Melhor Teclado para o seu gameplay   |            |Quantidade é obrigatório            |
        |Teclado Redragon         |300       |Melhor Teclado para o seu gameplay   |1000        |                                    |
        |Teclado Redragon         |300       |Melhor Teclado para o seu gameplay   |1000        |Já existe produto com esse nome     |